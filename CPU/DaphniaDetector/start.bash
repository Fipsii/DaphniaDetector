...
mv -f /app/ginjinnChanged /opt/conda/envs/ginjinnCPU/lib/python3.7/site-packages/ginjinn  > /dev/null 2>&1
...
conda run --no-capture-output -n DaphniaDetection python /app/DaphniaDetector/Main.py
