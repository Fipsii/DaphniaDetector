...
def group_lines(lines):
    ### Input list of lines generated by houghlinesP
...
def RoughCrop(Line_coordinates, Image_names):
...
def makeDfwithfactors(list_of_names, One_scale,List_of_scale_numbers=[], list_of_lengths=[], ConvFactor=0.002139):
...
### Find a better more flexible way to choose/create the right line threshold helps only a bit ###
### Problem sometimes double detect on a line sometimes not
### Biggest Problem: Incomplete lines at the bottom of a box
### Maybe build in inference ?
